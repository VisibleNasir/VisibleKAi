...
const Navbar = () => {
  ...
  return (
    ...
    px-4 sm:px-20 xl:px-32 '>
      ...
      {
        user ? <UserButton/> : (
            <button onClick={openSignIn} className="flex items-center gap-2 rounded-full test-sm cursor-pointer bg-primary text-white px-10 py-2.5" >Get Started <ArrowRight className='w-4 h-4 '/></button>
        )
      }
